  ...
  const globalPortals = [
    {
      ...
      description:
        'Explore the global headquarters hub, official leadership doctrines, and international statements of faith.',
      url: 'https://cogop.org',
      badge: 'Official HQ',
    },
    {
      ...
      description:
        'Read the White Wing Messenger archive, download global press updates, and stream international assemblies.',
    ...
    },
    {
      ...
      description:
        'Trace our global movement back to its 1886 roots in North Carolina and its formal 1903 assembly structure under pioneer ministers.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-400 leading-relaxed">
            ...
            movement that began in 1886 in North Carolina. Formally organized into an international
            missionary network in 1903, COGOP has grown to span over 130 nations and territories,
            working together to restore New Testament vibrancy.
          </p>
        </div>
        ...
        <div className="mt-16 border border-slate-800 bg-black/30 backdrop-blur-md rounded-2xl p-8 text-center max-w-4xl mx-auto">
          <p className="text-slate-300 italic font-medium leading-relaxed text-sm md:text-base">
            &quot;Reconciling the world to Christ through the power of the Holy Spirit—united in our
            covenant dedication to the infallible Word of God and local community
            transformation.&quot;
          </p>
