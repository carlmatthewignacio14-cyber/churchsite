...
const ministries: Ministry[] = [
  {
    ...
    tagline: 'Ages 13–35',
    description:
      'A vibrant space where teenagers discover identity, purpose, and community. Weekly gatherings, summer camps, and mission trips.',
    image: '/assets/images/710299155_970621969219794_887923649744832117_n-1783629134755.jpg',
    imageAlt: 'Youth ministry group photo',
    images: [
      {
        src: '/assets/images/710299155_970621969219794_887923649744832117_n-1783629134755.jpg',
        alt: 'Youth ministry group gathering',
      },
      {
        src: '/assets/images/710365609_970621589219832_6865443707344666283_n-1783629134773.jpg',
        alt: 'Youth ministry activity',
      },
      {
        src: '/assets/images/710474385_970622275886430_8079094559996432976_n-1783629134759.jpg',
        alt: 'Youth ministry event',
      },
      {
        src: '/assets/images/712504551_970622119219779_7872778213465183755_n-1783629134775.jpg',
  ...
  },
  {
    ...
    imageAlt:
      'Group of men in casual clothing gathered around a table in discussion, warm indoor lighting, community hall setting',
    tag: "Men's",
  },
  {
    id: 'worship',
    ...
    description:
      'Join our music ministry — vocalists, instrumentalists, and production crew welcome.',
    image: '/assets/images/727928138_988525360762788_1191887275324024034_n.jpg',
    imageAlt:
      'Worship band performing on a church stage, colored stage lighting, musicians playing guitars and keyboards, dimly lit sanctuary',
    tag: 'Worship',
  },
  {
    id: 'kids',
    ...
    description:
      'A fun, safe, and engaging environment where kids learn about faith through interactive Bible stories, worship, games, and creative crafts',
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-sm text-sm leading-relaxed font-light">
            There&apos;s a place for everyone here. Find the ministry that fits your season of life
            and step in.
          </p>
        </div>
        ...
        <div
          ref={gridRef}
          className={`grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-[280px] ${revealClass(gridRevealed)}`}
        >
          {ministries.map((m) => (
            <div
              key={m.id}
              className={`relative block overflow-hidden group bento-card ${m.colSpan || ''} ${m.rowSpan || ''}`}
            >
              {/* Image */}
              {m.images ? (
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        <path
                          ...
                          d="M13.5 4.5L21 12m0 0l-7-7.5M21 12H3"
                        />
                      </svg>
                    </div>
                  </Link>
