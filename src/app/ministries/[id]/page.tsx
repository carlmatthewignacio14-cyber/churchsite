...
const ministriesDetails: Record<string, {
  ...
  youth: {
    ...
    leader: {
      ...
      role: 'Youth Leader',
      bio: 'Sis. Zhaila has been leading youth ministry, passionate about seeing the next generation boldly live out their faith.',
  ...
  women: {
    ...
    leader: {
      ...
      bio: 'Sis. Nora has a heart for mentoring women through deep biblical study and creating safe spaces for authentic fellowship and healing.',
  ...
  men: {
    ...
    schedule: 'Every Saturday morning at 7:00 AM',
    leader: {
  ...
  worship: {
    ...
    schedule: 'Rehearsals every Saturday at 6:00 PM',
    leader: {
